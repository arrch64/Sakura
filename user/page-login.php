		...
		<?php if(!is_user_logged_in()){ ?>
			<div class="ex-login">
				...
				<form action="<?php echo home_url(); ?>/wp-login.php" method="post">  
					...
					<input class="button login-button" name="submit" type="submit" value="登 录">
				</form>
				<div class="ex-new-account" style="padding: 0;"><p>没有账号? 请先注册!</p><p><a href="<?php echo akina_option('exregister_url') ? akina_option('exregister_url') : bloginfo('url'); ?>" target="_blank">立即注册</a>|<a href="<?php echo site_url(); ?>/index.php/passreset" target="_blank">忘记密码?</a></p></div>
			</div>
